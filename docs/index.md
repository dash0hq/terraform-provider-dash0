...
Dataset-scoped resources (`dash0_dashboard`, `dash0_check_rule`, `dash0_recording_rule`, `dash0_spam_filter`, `dash0_synthetic_check`, `dash0_time_series_aggregation`, `dash0_view`) accept an optional `dataset` attribute.
