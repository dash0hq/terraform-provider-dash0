...
The Dash0 Terraform Provider manages Dash0 observability assets — dashboards, alerting rules, saved views, synthetic checks, notification channels, spam filters, time series aggregations, and teams — as Terraform resources.
...
- [`dash0_time_series_aggregation`](resources/time-series-aggregation) — metric rollups that cut cardinality and query cost.
