#!/usr/bin/env bash
# Roundtrip test for dash0_spam_filter (v1alpha1 shape).
#
# Steps:
...
info "=== Roundtrip test: dash0_spam_filter (v1alpha1) ==="
...
info "=== dash0_spam_filter (v1alpha1) roundtrip test PASSED ==="
