...
func (c *dash0Client) CreateView(ctx context.Context, check viewResourceModel) error {
...
func (c *dash0Client) UpdateView(ctx context.Context, check viewResourceModel) error {
