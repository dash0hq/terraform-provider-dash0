...
func convertToPrometheusRules(dash0CheckRuleJson string) (*PrometheusRules, error) {
	...
	nameParts := strings.Split(dash0CheckRule.Name, " - ")
	// TODO validate
	...
	promRules := &PrometheusRules{
		...
		Metadata: map[string]string{
			"name": strings.ToLower(strings.ReplaceAll(dash0CheckRule.Name, " ", "-")),
		},
...
func convertToDash0CheckRule(promRuleYaml string) (*Dash0CheckRule, error) {
