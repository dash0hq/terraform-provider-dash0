...
type Client interface {
	...
	CreateRecordingRuleGroup(ctx context.Context, origin string, groupJSON string, dataset string) error
	GetRecordingRuleGroup(ctx context.Context, origin string, dataset string) (string, error)
	UpdateRecordingRuleGroup(ctx context.Context, origin string, groupJSON string, dataset string) error
